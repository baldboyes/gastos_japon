...
<template>
  <div class="flex h-screen bg-gray-50">
    <!-- Sidebar -->
    <aside class="w-58 bg-white border-r hidden md:flex flex-col fixed inset-y-0 z-50">
      <div class="p-6 border-b bg-white" :style="`background-image: url('https://api.mevoyajapon.com/assets/${currentTrip?.portada}?width=255&format=webp'); background-size: cover; background-position: center;`">
    ...
    <!-- Main Content -->
    <main class="flex-1 flex flex-col min-w-0 md:pl-58">
      <!-- Mobile Header -->
