<template>
  <NuxtLayout name="default">
    <div class="container max-w-2xl mx-auto py-6 pb-24 px-4">
...
import { Bell, BellOff, Info, AlertTriangle, CheckCircle, AlertOctagon, Mail, Check, Trash2 } from 'lucide-vue-next'
