    ...
    <div class="container mx-auto px-4 py-42">
      <div class="max-w-4xl mx-auto text-center space-y-8">
        ...
        <p class="text-lg text-slate-600 max-w-2xl mx-auto">
          Próximamente encontrarás aquí artículos exclusivos para viajeros.
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 mt-12">
          ...
          <div class="group border border-slate-200 rounded-2xl p-4 bg-white shadow-sm hover:shadow-md transition-shadow flex flex-col">
            ...
            <div class="flex flex-col flex-grow justify-between">
              <div class="text-left">
                <h3 class="font-semibold text-lg text-slate-900">Sudadera Jizou Traveler</h3>
                <p class="text-slate-500 text-sm mb-4">Algodón orgánico, perfecta para vuelos largos.</p>
              </div>
          ...
          <div class="group border border-slate-200 rounded-2xl p-4 bg-white shadow-sm hover:shadow-md transition-shadow flex flex-col">
            ...
            <div class="flex flex-col flex-grow justify-between">
              <div class="text-left">
                <h3 class="font-semibold text-lg text-slate-900">Gorra Minimal</h3>
                <p class="text-slate-500 text-sm mb-4">Protégete del sol con estilo.</p>
              </div>
              <div class="flex items-center justify-between mt-auto">
          ...
          <div class="border border-slate-200 border-dashed rounded-2xl p-6 bg-slate-50/50 flex flex-col items-center justify-center text-slate-400 min-h-[300px]">
            <span class="text-sm font-medium">Más productos pronto...</span>
          </div>
...
useHead({
  title: 'Tienda - Gastos Trae',
  meta: [
    { name: 'description', content: 'Tienda de artículos para viajeros' }
  ]
})
</script>