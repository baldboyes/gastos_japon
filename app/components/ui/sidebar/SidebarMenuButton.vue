...
interface Props extends PrimitiveProps {
  ...
  isActive?: boolean
  class?: string
  tooltip?: string | { children: string; hidden?: boolean }
}
...
<template>
  <Primitive
    :as="as"
    :as-child="asChild"
    :data-sidebar="state === 'collapsed' ? 'menu-button' : 'menu-button'"
    :data-size="size"
