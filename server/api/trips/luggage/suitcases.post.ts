import { createDirectus, rest, readItems, readUsers, staticToken, createItem } from '@directus/sdk'
...
export default defineEventHandler(async (event) => {
  ...
  const created = await adminClient.request(createItem('suitcases', {
    trip_id: tripId,
    name,
    type
  } as any))

  return { suitcase: created }
})
