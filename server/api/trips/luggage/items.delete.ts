import { createDirectus, rest, readItem, readItems, readUsers, staticToken, deleteItem } from '@directus/sdk'
...
export default defineEventHandler(async (event) => {
  ...
  await adminClient.request(deleteItem('suitcase_items', itemId))
